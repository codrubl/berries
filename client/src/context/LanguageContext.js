...
const translations = {
  ro: {
    ...
    donate_success: 'Donație trimisă către {username}!',
    donate_view_tx: 'Vezi tranzacția pe Etherscan',
    donate_close: 'Închide',
    donate_err_no_metamask: 'MetaMask nu este instalat. Instalează extensia MetaMask pentru a putea dona.',
    donate_err_invalid_amount: 'Introdu o sumă validă, mai mare ca zero.',
    donate_err_no_account: 'Niciun cont selectat în MetaMask.',
    donate_err_generic: 'Tranzacția nu a putut fi finalizată. Încearcă din nou.',
    account_connect_wallet: '🦊 Conectează portofel MetaMask',
    account_wallet_connected: 'Portofel conectat! Apasă Salvează pentru a-l păstra.',
    ...
    account_wallet_hint: 'Adaugă adresa portofelului tău MetaMask pentru a primi donații',
  ...
  en: {
    ...
    donate_success: 'Donation sent to {username}!',
    donate_view_tx: 'View transaction on Etherscan',
    donate_close: 'Close',
    donate_err_no_metamask: 'MetaMask is not installed. Install the MetaMask extension to donate.',
    donate_err_invalid_amount: 'Enter a valid amount greater than zero.',
    donate_err_no_account: 'No account selected in MetaMask.',
    donate_err_generic: 'The transaction could not be completed. Please try again.',
    account_connect_wallet: '🦊 Connect MetaMask wallet',
    account_wallet_connected: 'Wallet connected! Press Save to keep it.',
    ...
    account_wallet_hint: 'Add your MetaMask wallet address to receive donations',
    account_username: 'Username',
